...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "px-8 pr-8 py-5 text-sm w-full bg-[#2a2a2a] text-[#f1f1f1] border border-[#333] outline-none placeholder:text-[#888] hover:border-[#1db954] hover:border-3 focus:border-[#1db954] active:border-[#1db954] transition-all",
